...
@ApplicationScoped
@RequiredArgsConstructor(onConstructor = @__(@Inject))   // Θα εισάγει μόνο τα final πεδία / lombok
public class TeacherServiceImpl implements ITeacherService {

    // org.slf4j.LoggerFactory; Dependency / Πάντα instantiate Με το όνομα της class!!
    private static final Logger LOGGER = LoggerFactory.getLogger(TeacherServiceImpl.class);


    // Αυτόματα κάνει η jakarta implement το dao
    // αυτό που κάναμε δηλαδή και κάνει
    // instantiate ένα new την κλάση που υλοποιεί το ITeacherDAO
    // -Δεν είνα τόσο καλό- -Καλύτερα στον constructor-
//    @Inject
//    private ITeacherDAO teacherDAO;

    private final ITeacherDAO teacherDAO;

    // Θα εισάγει μόνο τα final πεδία o Lombok, @RequiredArgsConstructor(onConstructor = @__(@Inject))
//    @Inject
