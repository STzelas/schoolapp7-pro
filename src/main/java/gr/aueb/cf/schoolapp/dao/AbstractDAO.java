...
public class AbstractDAO<T extends IdentifiableEntity> implements IGenericDAO<T> {
    ...
    public void setPeristenceClass(Class<T> peristenceClass) {
    ...
    public long count() {
        return getEntityManager()
                .createQuery("SELECT COUNT(e) FROM " + peristenceClass.getSimpleName() + " e", Long.class)
                .getSingleResult();
    }
    ...
    public long getCountByCriteria(Map<String, Object> criteria) {
        ...
        Root<T> entityRoot = countQuery.from(peristenceClass);
    ...
    public Optional<T> getById(Object id) {
        EntityManager em = getEntityManager();
        return Optional.ofNullable(em.find(peristenceClass, id));
    }
    ...
    public List<T> getAll() {
        return getByCriteria(getPeristenceClass(), Collections.emptyMap());
    }
